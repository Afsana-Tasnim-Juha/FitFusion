            ...
            <div className='mt-10'>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6 mb-6">
                    <div className='flex gap-2'>
                        ...
                        <img className='w-[200px] rounded-lg' src={f1} alt="" />
                        <div>
                    ...
                    <div className='flex gap-2'>
                        ...
                        <img className='w-[200px] rounded-lg' src={f2} alt="" />
                        <div>
                    ...
                    <div className='flex gap-2'>
                        ...
                        <img className='w-[200px] rounded-lg' src={f4} alt="" />
                        <div>
                    ...
                    <div className='flex gap-2'>
                        ...
                        <img className='w-[200px] rounded-lg' src={f5} alt="" />
                        <div>
